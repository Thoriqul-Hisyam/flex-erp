...
export function Header() {
  ...
  const brandName =
    permission.companyName && permission.companyName !== "-" ? permission.companyName : "Flex ERP";
  ...
  return (
    <header className="sticky top-0 z-30 -mt-3 pt-3 px-4 sm:px-6 shrink-0 bg-gradient-to-br from-[#eceff4] via-[#e8edf5] to-[#dfe6f0] dark:from-[#090c10] dark:via-[#0d1117] dark:to-[#0a0f18]">
      <div className="h-16 flex items-center justify-between border-b border-[#e6e9f0] dark:border-slate-800/60 select-none gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5 bg-white dark:bg-[#12161f] px-3.5 py-1.5 rounded-full shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#e6e9f0] dark:border-slate-800">
            {permission.companyLogoUrl && !logoError ? (
              /* eslint-disable-next-html-element-for-img */
              <img
                src={permission.companyLogoUrl}
                alt={brandName}
        ...
        <div className="hidden xl:flex items-center gap-1.5 bg-white dark:bg-[#12161f] px-3 py-1 rounded-full border border-[#e6e9f0] dark:border-slate-800 text-[11px] font-medium shadow-[0_4px_20px_rgba(0,0,0,0.03)]">
          ...
          {/* Branch/Warehouse are unset for a user whose scope isn't pinned that
              narrow (sees all branches/warehouses) - show nothing rather than "-". */}
          ...
          {displayWarehouse && displayWarehouse !== "-" && (
            <>
              <span className="text-[#8a94a6]">•</span>
              <div className="flex items-center gap-1 text-[#8a94a6] hover:text-[#0f172a] dark:hover:text-white transition-colors cursor-pointer px-2 py-0.5">
